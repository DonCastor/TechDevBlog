...
See [CHANGELOG.en.md](CHANGELOG.en.md) (*[version française](CHANGELOG.md)*).

## Code of Conduct

See [CODE_OF_CONDUCT.en.md](CODE_OF_CONDUCT.en.md) (*[version française](CODE_OF_CONDUCT.md)*).
